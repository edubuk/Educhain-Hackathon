...
const Resume: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-6 font-sans overflow-hidden">
      {/* PDF Download Button */}
      <button 
        onClick={generatePDF} 
        className="mb-4 px-4 py-2 bg-[#006666] text-white rounded shadow-md hover:bg-[#004d4d]"
      >
        Download as PDF
      </button>

      <div ref={pdfRef} className="bg-white w-full max-w-4xl shadow-xl rounded-lg p-8">
        {/* Header */}

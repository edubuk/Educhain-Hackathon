  ...
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-10">
      ...
      <p className="text-gray-600 mb-4">
        At Eduprovince, we understand that circumstances may arise where users need to 
      ...
      <p className="text-gray-600">
        Eduprovince reserves the right to modify or update this cancellation policy at any 
